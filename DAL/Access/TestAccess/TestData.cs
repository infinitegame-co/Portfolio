...
namespace DAL.Access.Test
{
    internal class TestData
    {
        ...
        internal TestData()
        {
            ...
            Users.Add(new AccountDTO(0, "Jim@Jim.com", "Jim", "D9B5F58F0B38198293971865A14074F59EBA3E82595BECBE86AE51F1D9F1F65E"));//Test123
            GuestBookEntries.Add(new GuestBookDTO(0, DateTime.MinValue, "This is good.", "Jim"));
            PortfolioDTO PORTFOLIO1 = new PortfolioDTO(0, "Test", new List<string>(), "This is pretty short for a portfolio.", DateTime.MinValue, new List<string>());
